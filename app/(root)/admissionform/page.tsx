    ...
    <>
      ...
      <div className="container mx-auto p-4 min-h-screen">
        ...
        <Formik
          ...
          onSubmit={async (values, { resetForm }) => {
            try {
              ...
              await addDoc(collection(db, "admissionDB"), {
                ...values,
                createdAt: new Date(),
              });
        ...
        >
          <Form className="grid grid-cols-1  lg:grid-cols-2  gap-4 border-4 p-10 border-gray-500 hover:border-gray-950 shadow-2xl rounded-xl">
            ...
            >
              ...
              <option value="Matric">Matric (Computer)</option>
              <option value="Intermediate">Matric (Biology)</option>
              <option value="Bachelor">ICS</option>
              <option value="Master">FSc. Pre-Engineering</option>
              <option value="Master">FSc. Pre-Medical</option>
            </Field>
            {/* 
          <Field
          ...
          >
            ...
            <Button
              type="submit"
              className="w-40 mx-auto transform hover:scale-105 transition-all duration-300"
            >
              Submit
            </Button>
          </Form>
        ...
        <div className="text-red-500 mt-4 border-b border-gray-300 p-4">
          <p>
            <b>Note:</b> Please attach the following required attested documents
            with this form:
          </p>
